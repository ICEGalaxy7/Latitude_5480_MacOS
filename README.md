...
<h4> Important : this EFI is meant for Monterey, if you're willing to boot into Big Sur, please make sure you remove "BlutoothFixup.kext" from /EFI/Clover/Kexts/other, make sure you redownload the Big Sur Release of <a href="https://github.com/OpenIntelWireless/itlwm">"Airportitlwm.kext"</a> in order for WiFi to work !</h4>
 <br>
<h4>My Specs</h4>
<ul>
